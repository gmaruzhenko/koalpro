...
const DummySnowflakeDBImport = ({data, id}) => {
    ...
    const [fileName, setFileName] = useState("../../resources/Worldwide Current purchased sticks.csv");//TODO hook this up to data and default "None Selected"
...
export default DummySnowflakeDBImport;